...
//-----------------P4----------------
	...
	////---obj1----
	////GL_SMOOTH, stationary, lighted, not textured, shiny
	//glPushMatrix();
	//SetMaterial(1.0, 1.0, 1.0, 150.0);


	//glTranslatef(15., 12., -15.);
	...
	////---obj2---- 
	////GL_SMOOTH, moving, lighted, not textured (have color), shiny
	////rotate cube
	//glPushMatrix();
	//SetMaterial(1.0, 1.0, 1.0, 150.0);
	////this control the color of the obj
	//glShadeModel(GL_SMOOTH);
	//glTranslatef(-15., -12., -15.);
	...
	////---obj3----
	////GL_FLAT, stationary, lighted, textured, dull
	//glPushMatrix();

	//glShadeModel(GL_FLAT);
	//SetMaterial(1.0, 1.0, 1.0, 2.0);
	...
	////spot light 1
	////stationary, spotlight, yellow
	//SetSpotLight(GL_LIGHT1, 20, 20, 20, 0, 0, -1, 1.0, 1.0, 0.0);

	////point light 2 moving
	////moving, spotlight, purple
	//SetSpotLight(GL_LIGHT2, loc, 2., 2., 0, 0, -1, 1., 0., 1);
	//glDisable(GL_LIGHTING);
